...
A curated stream of AI Agent papers with independent research notes. Content is stored as Markdown and does not depend on an external document system. Each paper note separates verifiable sources, community evidence, author claims, and research judgment.

## Start here

- [Daily updates](daily/README.en.md)
- [Paper research](papers/README.en.md)
- [Monthly reports](monthly/README.en.md)
- [2026 trends, January–July](docs/2026-trends.en.md)
- [Category guide](docs/categories.en.md)
- [Content templates](templates)

## Selection policy

- The normal daily volume is 0–2 papers. A rolling seven-day window usually contains no more than 7 papers and may reach 10 only when several high-confidence papers appear together.
- The monthly target is 20–35 papers. This is a capacity range, not a quota; a month may contain fewer than 20 papers when the evidence is insufficient.
- A score of 70 is only the candidate threshold. Independent research normally requires a score of at least 78.
- Facts, author claims, community opinions, and research judgments are stated separately. Unverified evidence is labeled explicitly.
- Screenshots are limited quotations from the original paper. Each image must include its figure or table number, page, source, interpretation, and limitations.

## Overview

<!-- BEGIN AUTO:OVERVIEW -->
- Independent research notes: **32**
- Papers covered by monthly reports: **165**
- Daily updates: **22**
- Monthly reports: **7**
- Primary-category distribution: [AF](docs/categories.en.md#af) 2, [AT](docs/categories.en.md#at) 5, [CU](docs/categories.en.md#cu) 2, [EA](docs/categories.en.md#ea) 1, [EV](docs/categories.en.md#ev) 11, [KM](docs/categories.en.md#km) 1, [MA](docs/categories.en.md#ma) 1, [RA](docs/categories.en.md#ra) 2, [RP](docs/categories.en.md#rp) 2, [SE](docs/categories.en.md#se) 3, [SS](docs/categories.en.md#ss) 2
...
| 2026-07-29 | [KM](docs/categories.en.md#km) | [Metis: Memory Foundation Model](papers/2026/07/2607.26760.en.md) | [2607.26760](https://arxiv.org/abs/2607.26760) |
...
- [2026-04](monthly/2026-04.en.md)
- [2026-03](monthly/2026-03.en.md)
- [2026-02](monthly/2026-02.en.md)
- [2026-01](monthly/2026-01.en.md)
<!-- END AUTO:OVERVIEW -->

## Repository layout

```text
daily/YYYY-MM-DD.md             Chinese daily update
daily/YYYY-MM-DD.en.md          English daily update
papers/YYYY/MM/ARXIV_ID.md      Chinese independent research note
papers/YYYY/MM/ARXIV_ID.en.md   English independent research note
monthly/YYYY-MM.md              Chinese monthly report
monthly/YYYY-MM.en.md           English monthly report
assets/papers/ARXIV_ID/         Figures quoted from the original paper
templates/                      Chinese and English Markdown templates
scripts/build_overview.py       Rebuild repository indexes
scripts/validate_monthly.py     Validate monthly coverage and structure
scripts/validate_bilingual.py   Validate Chinese–English companion coverage
```
